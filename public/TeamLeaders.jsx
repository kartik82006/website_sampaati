...
const TeamLeaders = () => {
  ...
  const handleCardClick = (teamLink) => (
    <TeamMembers teamName={teamLink} />
  );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            {teamLeaders.map((leader) => (
              <div
                ...
                onClick={() => handleCardClick(leader.teamLink)}
              >
                {/* Profile Image */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center text-blue-300 text-sm font-medium hover:translate-x-1 transition-all duration-300 group">
