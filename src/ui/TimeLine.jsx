        ...
        return (
          ...
          >{/* Left or Right alignment based on index */}
            ...
            <div className={`w-full md:w-1/2 px-4 ${isLeft?"":"order-2"}` }>
              <div className=" p-6 rounded-lg shadow-md bg-[#0B101E] m-4">
          ...
          <div className={`w-full md:w-1/2 px-4 ${isLeft?":order-2":""} `}>
              <div className=" p-4 rounded-lg shadow-md bg-[#0B101E] hover:bg-[#1E293B] transition-colors transition-transform hover:scale-105 duration-500 ease-in-out m-2 ">
