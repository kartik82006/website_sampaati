        ...
        <div className="space-y-0">
          {projects.map((project) => (
            <div key={project.id} className="relative">
              ...
              >
                <div className={`p-8 transition-all duration-400 ${
                  hoveredProject?.id === project.id 
                    ? 'transform translate-y-0 opacity-100' 
                    : 'transform translate-y-6 opacity-0'
                }`}>
                  <div className={`grid md:grid-cols-2 gap-8 transition-all duration-300 delay-100 ${
                    hoveredProject?.id === project.id 
                      ? 'transform translate-y-0 opacity-100' 
                    ...
                    <div className={`transition-all duration-300 delay-200 ${
                      ...
                      <div className={`relative mb-6 transition-all duration-400 delay-250 ${
                        hoveredProject?.id === project.id 
                      ...
                      {/* Action Buttons */}
                      <div className={`flex gap-4 transition-all duration-400 delay-350 ${
                        hoveredProject?.id === project.id 
                          ? 'transform translate-y-0 opacity-100' 
                          : 'transform translate-y-4 opacity-0'
                      }`}>
                    ...
                    <div className={`transition-all duration-300 delay-200 ${
                      ...
                      <div className={`mb-6 transition-all duration-400 delay-250 ${
                        hoveredProject?.id === project.id 
                          ? 'transform translate-y-0 opacity-100' 
                          : 'transform translate-y-6 opacity-0'
                      }`}>
