...
const DepartmentCard = ({ department }) => {
  ...
  return (
    <div id="department" className="scroll-snap-start p-4 flex-shrink-0 w-[80vw] sm:w-[60vw] md:w-[40vw] lg:w-[30vw] xl:w-[25vw] transition-transform duration-500 ease-in-out">
      <div className="dark:bg-[#0F172B] rounded-2xl shadow-xl p-6 flex flex-col items-center transition-all duration-500 ease-in-out transform hover:scale-105 h-[32rem]">
        <img
...
const DepartmentCarousel = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen font-sans overflow-hidden py-6">
      ...
      <button
        onClick={() => scroll('left')}
        className="absolute left-1 top-1/2 transform -translate-y-1/2 bg-transparent text-white px-1 pb-2 m-1 rounded-xl shadow-lg z-10 hover:bg-cyan-600 text-4xl"
      >
        {'<'}
      </button>
      <button
        onClick={() => scroll('right')}
        className="absolute right-1 top-1/2 transform -translate-y-1/2 bg-transparent text-white px-1 pb-2 rounded-xl shadow-lg z-10 hover:bg-cyan-600 text-4xl"
      >
        {'>'}
      </button>
