...
const DepartmentCarousel = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen font-sans overflow-hidden py-6">
      ...
      <button
        onClick={() => scroll('left')}
        className="absolute left-2 text-2xl top-1/2 transform -translate-y-1/2 bg-cyan-600 text-white p-3 rounded-xl shadow-lg z-10 hover:bg-cyan-700"
      >
        {'<'}
      </button>
      <button
        onClick={() => scroll('right')}
        className="absolute right-2 text-2xl top-1/2 transform -translate-y-1/2 bg-cyan-600 text-white p-3 rounded-xl shadow-lg z-10 hover:bg-cyan-700"
      >
        {'>'}
      </button>
